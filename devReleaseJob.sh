...
./addUniverseFilesToUniverseMainBranch.sh  $ENVIRONMENT tmp/stub-universe-mds-cassandra/repo/packages/M/mds-cassandra/0  ${FRAMEWORK_VERSION} ${UNIVERSE_FOLDER_NUMBER}
if [ $? -ne 0 ]; then
